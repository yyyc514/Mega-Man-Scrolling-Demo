...
void Arduboy::drawSprite(int16_t x, int16_t y, const uint8_t *bitmap)
{
  drawSprite(x, y, bitmap, 0, NULL, 0);
}
void Arduboy::drawSprite(int16_t x, int16_t y, const uint8_t *bitmap, const uint8_t *mask)
{
  drawSprite(x, y, bitmap, 0, mask, 0);
}
void Arduboy::drawSprite(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame)
{
  drawSprite(x, y, bitmap, frame, NULL, 0);
}
void Arduboy::drawSprite(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame, const uint8_t *mask, uint8_t sprite_frame)
{
...
void Arduboy::drawComplexBitmap(int16_t x, int16_t y,
